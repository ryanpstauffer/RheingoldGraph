...
_sym_db.RegisterEnumDescriptor(_PITCHNAME)

PitchName = enum_type_wrapper.EnumTypeWrapper(_PITCHNAME)
...
_NOTESEQUENCE = _descriptor.Descriptor(
  ...
  nested_types=[_NOTESEQUENCE_TIMESIGNATURE, _NOTESEQUENCE_KEYSIGNATURE, _NOTESEQUENCE_TEMPO, _NOTESEQUENCE_PITCHBEND, _NOTESEQUENCE_CONTROLCHANGE, _NOTESEQUENCE_PARTINFO, _NOTESEQUENCE_SOURCEINFO, _NOTESEQUENCE_TEXTANNOTATION, _NOTESEQUENCE_QUANTIZATIONINFO, _NOTESEQUENCE_SUBSEQUENCEINFO, _NOTESEQUENCE_SECTIONANNOTATION, _NOTESEQUENCE_SECTION, _NOTESEQUENCE_SECTIONGROUP, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
...
_NOTE = _descriptor.Descriptor(
  name='Note',
  full_name='tensorflow.magenta.Note',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='pitch', full_name='tensorflow.magenta.Note.pitch', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='pitch_name', full_name='tensorflow.magenta.Note.pitch_name', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='velocity', full_name='tensorflow.magenta.Note.velocity', index=2,
      number=2, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='start_time', full_name='tensorflow.magenta.Note.start_time', index=3,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='quantized_start_step', full_name='tensorflow.magenta.Note.quantized_start_step', index=4,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='end_time', full_name='tensorflow.magenta.Note.end_time', index=5,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='quantized_end_step', full_name='tensorflow.magenta.Note.quantized_end_step', index=6,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='numerator', full_name='tensorflow.magenta.Note.numerator', index=7,
      number=5, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='denominator', full_name='tensorflow.magenta.Note.denominator', index=8,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='instrument', full_name='tensorflow.magenta.Note.instrument', index=9,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='program', full_name='tensorflow.magenta.Note.program', index=10,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='is_drum', full_name='tensorflow.magenta.Note.is_drum', index=11,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='part', full_name='tensorflow.magenta.Note.part', index=12,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='voice', full_name='tensorflow.magenta.Note.voice', index=13,
...
_NOTESEQUENCE.fields_by_name['notes'].message_type = _NOTE
...
_NOTE.fields_by_name['pitch_name'].enum_type = _PITCHNAME
...
DESCRIPTOR.enum_types_by_name['PitchName'] = _PITCHNAME
...
Note = _reflection.GeneratedProtocolMessageType('Note', (_message.Message,), dict(
  DESCRIPTOR = _NOTE,
  __module__ = 'music_pb2'
  # @@protoc_insertion_point(class_scope:tensorflow.magenta.Note)
  ))
